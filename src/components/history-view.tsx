...
import { loadData, saveData, exportData, exportCSV, AppData } from '@/lib/storage'
    ...
    <Card>
      ...
      <CardContent>
        {sortedDates.length === 0 ? (
          <p className="text-muted-foreground py-8 text-center">No history yet. Start tracking to see your progress!</p>
        ) : (
                ...
                <Card key={date} className="border">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-muted-foreground text-sm">Total: {totalHours.toFixed(2)}h</span>
                    </div>
                  </CardHeader>
                  <CardContent className="pt-0">
                    <div className="space-y-2">
                      {dayRecord.tasks.map((task) => (
                        <div key={task.id} className="bg-muted/50 flex items-center justify-between rounded-md p-3">

...
import { getReminders, saveReminders, Reminder, getReminderHistory, addReminderHistory } from '@/utils/storage';
...
export const ReminderManager = () => {
  ...
  const addReminder = () => {
    ...
    const description = reminderType === 'interval' 
  ...
  const toggleChecked = (id: string) => {
    ...
    setReminders(reminders.map(r =>
      r.id === id ? { ...r, checkedToday: !r.checkedToday } : r
    ));
  };
        ...
        <Tabs defaultValue="reminders" className="w-full">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        <Checkbox
                          checked={reminder.checkedToday}
                          onCheckedChange={() => toggleChecked(reminder.id)}
                        />
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold truncate">{reminder.name}</h3>
          ...
          <TabsContent value="history" className="space-y-4 mt-4">
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Today's Completions ({getTodayHistory().length})</h3>
                <div className="space-y-2">
              ...
              <div>
                <h3 className="font-semibold mb-2">All History</h3>
